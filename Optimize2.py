...
for i in range(10000):
    ...
    loss_partial = mse.get_partial()
    dense3.update_weights(loss_partial)
    dense2.update_weights(dense3.get_partial(loss_partial))
    dense1.update_weights(dense2.get_partial(dense3.get_partial(loss_partial)))